 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,...r),n}(me({apiKey:"AIzaSyAi4Znr4vdnDxyTidQOWSzpihwHJ_F7dpk",authDomain:"parcel-test-repo.firebaseapp.com",projectId:"parcel-test-repo",storageBucket:"parcel-test-repo.appspot.com",messagingSenderId:"13724922883",appId:"1:13724922883:web:f45f7c2c45c92bbf034a36",measurementId:"G-V2E0KQV90H"}));Wt.addEventListener("click",(e=>{e.preventDefault();const t=Gt.files[0];!function(e,t){jt(Vt(Xt,t),e).then((e=>{console.log("Uploaded a blob or file!")}))}(t,`./${t.name}`)})),qt.addEventListener("click",(e=>{var t;e.preventDefault(),(t=Vt(Xt,"./img.jpg"),Ut(t=N(t))).then((e=>{const t=new XMLHttpRequest;t.responseType="blob",t.onload=e=>{t.response},t.open("GET",e),t.send()})).catch((e=>{}))})),Kt.addEventListener("click",(e=>{e.preventDefault();const t=Vt(Xt,"./Glossary 2 + Text UA.docx.pdf");var n;(n=t,Bt(n=N(n))).then((()=>{console.log("deleted")})).catch((e=>{}))}));
//# sourceMappingURL=index.620c3487.js.map
