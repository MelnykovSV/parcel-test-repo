 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,...r),n}(me({apiKey:"AIzaSyAi4Znr4vdnDxyTidQOWSzpihwHJ_F7dpk",authDomain:"parcel-test-repo.firebaseapp.com",projectId:"parcel-test-repo",storageBucket:"parcel-test-repo.appspot.com",messagingSenderId:"13724922883",appId:"1:13724922883:web:f45f7c2c45c92bbf034a36",measurementId:"G-V2E0KQV90H"}));zt.addEventListener("click",(e=>{e.preventDefault();const t=qt.files[0];!function(e,t){Ht(jt(Kt,t),e).then((e=>{console.log("Uploaded a blob or file!")}))}(t,`./${t.name}`)})),Wt.addEventListener("click",(e=>{var t;e.preventDefault(),(t=jt(Kt,"./file.pdf"),Ut(t=N(t))).then((e=>{console.log(e);const t=new XMLHttpRequest;t.responseType="blob",t.onload=e=>{t.response},t.open("GET",e),t.send(),console.log(t)})).catch((e=>{}))}));
//# sourceMappingURL=index.888d2614.js.map
